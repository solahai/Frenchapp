...
class OpenAIService {
    constructor() {
        ...
        this.client = new openai_1.default({ apiKey: apiKey || 'dummy-key' });
    }
    /**
     * Generate a French conversation response
     */
    async generateConversationResponse(messages, scenario, level, strictMode = true) {
        ...
        try {
            ...
            throw new errorHandler_1.AIServiceError('Failed to generate conversation response');
        }
    }
    /**
     * Analyze and correct French text
     */
    async analyzeAndCorrect(text, level, context = 'general') {
...
Respond in JSON format:
{
  ...
  "shouldRepair": boolean (true if major errors need immediate correction)
        ...
        try {
            ...
            throw new errorHandler_1.AIServiceError('Failed to analyze text');
        }
    }
    /**
     * Generate kid-simple grammar explanation
     */
    async explainGrammar(topic, level, userQuestion) {
...
Respond in JSON format:
{
  ...
  "quickCheck": {"question": "a simple test question", "answer": "the answer"}
        ...
        try {
            ...
            throw new errorHandler_1.AIServiceError('Failed to generate grammar explanation');
        }
    }
    /**
     * Generate daily lesson content
     */
    async generateLessonContent(level, theme, previousVocabulary, focusGrammar) {
  ...
  "culturalNugget": {
    ...
    "funFact": "a surprising fun fact"
        ...
        try {
            ...
            throw new errorHandler_1.AIServiceError('Failed to generate lesson content');
        }
    }
    /**
     * Generate pronunciation feedback
     */
    async analyzePronunciation(targetText, transcription, level) {
...
Respond in JSON format:
{
  ...
  "actionableFixes": ["specific tip 1", "specific tip 2", "specific tip 3"]
        ...
        try {
            ...
            throw new errorHandler_1.AIServiceError('Failed to analyze pronunciation');
        }
    }
    /**
     * Generate remediation exercises for specific errors
     */
    async generateRemediationExercises(errorType, errorExamples, level) {
  ...
  "exercises": [
    {
      ...
      "items": [
        ...
        try {
            ...
            throw new errorHandler_1.AIServiceError('Failed to generate remediation exercises');
        }
    }
    /**
    ...
    async transcribeAudio(audioBuffer, language = 'fr') {
        try {
            ...
            throw new errorHandler_1.AIServiceError('Failed to transcribe audio');
        }
    }
    // Private helper methods
    buildConversationSystemPrompt(scenario, level, strictMode) {
...
Always be encouraging about what they did well, but never skip important corrections.`;
    ...
    parseConversationResponse(content) {
